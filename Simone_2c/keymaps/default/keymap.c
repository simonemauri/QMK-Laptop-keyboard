 ...
 */
  ...
  _______, _______, _______, _______, _______, _______, _______, KC_7, KC_8, KC_9, KC_KP_SLASH, _______, _______, _______, _______, \
  _______, _______, _______, _______, _______, _______, _______, KC_4, KC_5, KC_6, KC_KP_ASTERISK, _______, _______, _______, _______, \
  _______, _______, _______, _______, _______, _______, _______, KC_1, KC_2, KC_3, KC_KP_MINUS, _______, _______, _______, \
  _______, _______, _______, _______, _______, _______, _______, _______, KC_0, _______, _______, KC_KP_PLUS, _______, _______, \
  ...
  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_SYSTEM_SLEEP, XXXXXXX, XXXXXXX, XXXXXXX, KC_AUDIO_MUTE, XXXXXXX, XXXXXXX, KC_NUMLOCK, KC_SCROLLLOCK, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,\
  ...
  XXXXXXX, _______, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_AUDIO_VOL_UP, XXXXXXX, \
                                                              KC_BRIGHTNESS_DOWN, KC_AUDIO_VOL_DOWN, KC_BRIGHTNESS_UP \
  ),
  ...
  switch (keycode) {
    case KC_NUMLOCK:
      if (record->event.pressed) {
        ...
        SEND_STRING("Release!   ");	// Do something else when release
      }
